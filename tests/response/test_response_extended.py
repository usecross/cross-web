...
def test_response_json_none_body():
...
def test_response_json_empty_object():
...
def test_response_with_cookies():
    cookies = [
...
def test_to_fastapi_with_cookies():
    cookies = [
        Cookie(
            name="auth",
            value="token123",
