...
def test_http_exception_initialization():
...
def test_http_exception_different_status_codes():
...
def test_http_exception_inheritance():
...
def test_http_exception_as_base_exception():
