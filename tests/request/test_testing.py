...
@pytest.mark.asyncio
async def test_testing_request_adapter_defaults():
...
@pytest.mark.asyncio
async def test_testing_request_adapter_custom_values():
    adapter = TestingRequestAdapter(
        method="GET",
...
@pytest.mark.asyncio
async def test_testing_request_adapter_json_body():
...
@pytest.mark.asyncio
async def test_testing_request_adapter_mixed_data():
...
@pytest.mark.asyncio
async def test_testing_request_adapter_empty_json():
...
@pytest.mark.asyncio
async def test_testing_request_adapter_complex_json():
    complex_data = {
        "nested": {"inner": [1, 2, 3]},
        "boolean": True,
        "null": None,
