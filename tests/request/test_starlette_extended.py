...
@pytest.mark.asyncio
async def test_starlette_adapter_headers_caching():
...
@pytest.mark.asyncio
async def test_starlette_adapter_no_content_type():
...
@pytest.mark.asyncio 
async def test_starlette_adapter_empty_body():
...
@pytest.mark.asyncio
async def test_starlette_adapter_form_only():
    ...
    assert form_data.files == mock_form_data  # In Starlette adapter, both point to same data