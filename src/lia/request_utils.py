...
def is_request_allowed(request: BaseRequestProtocol, allowed_methods: tuple[str, ...] = ("GET", "POST")) -> bool:
...
def should_render_ide(
    ...
    return any(supported_header in accept_header for supported_header in supported_headers)


def parse_query_params(params: QueryParams, json_fields: tuple[str, ...] = ("variables", "extensions")) -> dict[str, Any]:
